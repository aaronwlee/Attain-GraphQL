...
```
> The resolvers are will receive four parameters
...
- context: any <br /> Authentication token to send each resolver
- middlewares?: CallBackType[]; <br /> `(req, res) => any` added before execute the GQL post request
